...
"""
    ...
    def test_constant_folding_in_arithmetic_expression(self):
        code = """
PROGRAM T
INTEGER X
X = 2 + 3 * 4
...
"""
    ...
    def test_constant_folding_in_unary_and_comparison(self):
        code = """
PROGRAM T
LOGICAL L1, L2
L1 = .NOT. .FALSE.
...
"""
    ...
    def test_unary_simplification_with_nested_negation(self):
        code = """
PROGRAM T
INTEGER X
X = -(-3)
...
"""
    ...
    def test_unary_simplification_with_double_not(self):
        code = """
PROGRAM T
LOGICAL L
L = .NOT. .NOT. .TRUE.
...
"""
    ...
    def test_constant_comparison_simplification(self):
        code = """
PROGRAM T
LOGICAL L1, L2, L3
L1 = 2 .LT. 5
...
"""
    ...
    def test_constant_comparison_inside_if_expression(self):
        code = """
PROGRAM T
INTEGER X
X = 0
...
"""
    ...
    def test_constant_false_if_eliminates_then_branch(self):
        code = """
PROGRAM T
INTEGER X
X = 0
...
"""
        ...
        self.assertEqual(
            ...
            "\n".join(
                [
                    ...
                    "ASSIGN X -1",
                    "t1 = BINOP .LT. X 0",
                    "JUMP_IF_FALSE t1 ARIF_ZERO1",
                    "JUMP LABEL_10",
                    "ARIF_ZERO1:",
                    "t2 = BINOP .EQ. X 0",
                    "JUMP_IF_FALSE t2 ARIF_POS2",
                    "JUMP LABEL_20",
                    "ARIF_POS2:",
                    "LABEL_10:",
                    "LABEL_20:",
    ...
    def test_constant_arithmetic_if_jumps_directly(self):
        code = """
PROGRAM T
IF (-1) 10, 20, 30
10 CONTINUE
